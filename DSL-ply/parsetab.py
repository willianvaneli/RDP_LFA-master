...
_lr_productions = [
  ...
  ('term -> term EXPONENT term','term',3,'p_term','parser.py',227),
  ('term -> term MULTIPLY term','term',3,'p_term','parser.py',228),
  ('term -> term DIVIDE term','term',3,'p_term','parser.py',229),
  ('term -> term DIVIDEINT term','term',3,'p_term','parser.py',230),
  ('term -> term QUOTIENT term','term',3,'p_term','parser.py',231),
  ('term -> term MINUS term','term',3,'p_term','parser.py',232),
  ('term -> term PLUS term','term',3,'p_term','parser.py',233),
  ('term -> term IGUAL term','term',3,'p_term','parser.py',234),
  ('term -> term MENOR term','term',3,'p_term','parser.py',235),
  ('term -> term MAIOR term','term',3,'p_term','parser.py',236),
  ('term -> term MENORIGUAL term','term',3,'p_term','parser.py',237),
  ('term -> term MAIORIGUAL term','term',3,'p_term','parser.py',238),
  ('term -> factor','term',1,'p_term_factor','parser.py',245),
  ('factor -> nterm','factor',1,'p_factor','parser.py',252),
  ('factor -> NUMBER','factor',1,'p_factor','parser.py',253),
  ('factor -> positive','factor',1,'p_factor','parser.py',254),
  ('factor -> negative','factor',1,'p_factor','parser.py',255),
  ('negative -> MINUS term','negative',2,'p_negative','parser.py',262),
  ('positive -> PLUS term','positive',2,'p_positive','parser.py',268),
  ('nterm -> LPAR term RPAR','nterm',3,'p_nterm','parser.py',275),
  ('term -> NAME','term',1,'p_term_var','parser.py',282),
